...
urlpatterns = [
    ...
    path('planning/', views.generar_planing, name='planning'),  # Ruta correcta para generar_planing
    path('', home, name='home'),
    path('__debug__/', include('debug_toolbar.urls')),
    path('update_checkins_checkouts/', views.update_checkins_checkouts, name='update_checkins_checkouts'),
    path('update_fecha_inicio/', views.update_fecha_inicio, name='update_fecha_inicio'),
    path('reservas/detalle/<int:reserva_id>/', views.detalle_reserva, name='detalle_reserva'),
    path('detalles_habitacion/<int:numero_habitacion>/', views.detalles_habitacion, name='detalles_habitacion'),
    path('accounts/login/', auth_views.LoginView.as_view(), name='login'),  # Vista de login
